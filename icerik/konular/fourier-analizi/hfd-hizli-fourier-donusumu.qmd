...
Bir sinyalin frekans uzayını kullanarak örneklem miktarını arttıralım. Bunn için örnek bir sinyal oluşturacağız. Bu sinyalin örneklem sayısını frekans uzayında arttırıp efektif olarak interpolasyon yapacağız. 
