...
1. Gürültü filtreleme işlemini `problem2-gurultulu-sinyal.wav` dosyası için yapın. Dosyaya [bu linkten](../../../sesler/problem2-gurultulu-sinyal.wav.wav) ulaşabilirsiniz. Bu dosya C akoru ve G akorunu ardı ardına eklenerek oluşturulmuştur.
...
8. Filtrelenmiş ses dosyasını `problem2-gurultusuz-sinyal.wav.wav` olarak kaydedin.