...
9. Tüm değişkenleri `write("<dosya_adi>.wav", örnekleme_oranı, <degisken>)` ile kaydedin.
...
6. Tüm değişkenleri oranlayın (scaling) ve `write("<dosya_adi>.wav", örnekleme_oranı, <oranli-degisken>)` ile kaydedin.
...
2. _Observation of Gravitational Waves from a Binary Black Hole Merger_ başlığına tıklayınız. Burada hem Hanford hem de Livingston merkezlerinden alınan veriler bulunmaktadır. Aşağıdaki linklerden verileri indirin.
   1. <https://gwosc.org/GW150914data/P150914/fig1-observed-H.txt>
   2. <https://gwosc.org/GW150914data/P150914/fig1-observed-L.txt>
3. Verilerin grafiğini üst üste çizdirin.
4. Verileri wav dosyası olarak kaydedin. (https://www.youtube.com/watch?v=TWqhUANNFXw)
5. Verilerin Fourier dönüşümünü yapın ve grafiklerini çizdirin.

### Problem 2

**Gürültü Silme**

1. Gürültü filtreleme işlemini ve mi notasını (329.63 Hz) çıkarma işlemini `problem2-gurultulu-sinyal.wav` dosyası için yapın. Bu dosyaya [bu linkten](../../../sesler/problem2-gurultulu-sinyal.wav.wav) ulaşabilirsiniz. Bu ses dosyası C akoru ve G akoru ardı ardına eklenerek oluşturulmuştur.
2. Bu ses dosyasındaki G akorundaki sol notasını (392 Hz) çıkarın.