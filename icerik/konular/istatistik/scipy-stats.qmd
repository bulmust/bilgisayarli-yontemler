...
![Normal Dağılım](assets/normal_dagilim.png)
...
Alt Sınır $=\mu - (z \times \sigma)$
Üst Sınır $=\mu + (z \times \sigma)$
...
Burada $\sigma$ standart sapma ve $n$ örneklem sayısıdır.
- Bizim örneğimizde standart hata $0.5/\sqrt{100}=0.05$ olacaktır.
- Standart hatayı da kullanarak elde edilen güven aralığı $7 \pm 1.96 \times 0.05 = 6.9, 7.1$ olacaktır.
